...
<form action="#">
	<table>
		<tr><td>包名：</td><td colspan="3"><input type="text" name="package" id="package" value="com.yueqian.gen"></td></tr>
		<tr><td>表名：</td><td colspan="3"><input type="text" name="table" id="table" value="emp_tab"></td></tr>
		<tr>
			<td>列名：</td>
			<td>
				<input type="text" name="colName1" id="colName1" value="emp_no">
			</td>
			<td>
				类型：<input type="text" name="colType1" id="colType1" value="int(5)">
			</td>
			<td>
		...
		<tr>
			<td>列名：</td>
			<td>
				<input type="text" name="colName2" id="colName2" value="e_name">
			</td>
			<td>
				类型：<input type="text" name="colType2" id="colType2" value="varchar(20)">
			</td>
			<td>
				<input type="button" value="+" id="addColBtn2" onclick="addCol(this)">
			</td>
		</tr>
		<tr><td>列名：</td>
			<td>
				<input type="text" name="colName3" id="colName3" value="e_sal">
			</td>
			<td>
				类型：<input type="text" name="colType3" id="colType3" value="float(10,2)">
			</td>
			<td>
				<input type="button" value="+" id="addColBtn3" onclick="addCol(this)">
			</td>
		</tr>
		<tr><td>列名：</td>
			<td>
				<input type="text" name="colName4" id="colName4" value="e_hiredate">
			</td>
			<td>
				类型：<input type="text" name="colType4" id="colType4" value="date">
			</td>
			<td>
				<input type="button" value="+" id="addColBtn4" onclick="addCol(this)">
			</td>
		</tr>
		<tr>
